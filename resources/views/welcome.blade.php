      ...
      <div class="col-lg-8">
        <div class="card shadow-sm border-0">
          <div class="card-header bg-primary text-white py-3">
            <h5 class="mb-0">নতুন প্রোডাক্ট যোগ করুন</h5>
            ...
            <form action="{{ route('products.store') }}" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <select class="form-select" id="category" required name="category">
                    ...
                    <option value="home-appliance">হোম অ্যাপ্লায়েন্স</option>
                  </select>
                </div>
                <!-- Brand -->
                <div class="col-md-6 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="number" class="form-control" id="stock" value="1" required name="stock">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="description" rows="4"
                  placeholder="প্রোডাক্ট সম্পর্কে বিস্তারিত লিখুন..." name="description"></textarea>
              </div>
